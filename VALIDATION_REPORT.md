...
| PASS | cards | visible_symbols | 35 visible symbols returned |
...
| PASS | CSI500 | source_trust | 官方 |
| PASS | CSI500 | freshness | 26s |
...
| PASS | CSI_DIVIDEND | freshness | 23s |
...
| PASS | CSI_DIVIDEND_QUALITY | freshness | 21s |
...
| PASS | CSI_ALL_DIVIDEND_QUALITY | freshness | 20s |
...
| PASS | CNI_FREE_CASH_FLOW | freshness | 18s |
...
| PASS | CN10Y | change_pct_math | OK |
| PASS | CN10Y | source_trust | 官方 |
| PASS | CN10Y | freshness | 18s |
...
| PASS | US10Y | change_pct_math | OK |
| PASS | US10Y | source_trust | 官方 |
| PASS | US10Y | freshness | 18s |
...
| PASS | DAX | card_field:source_url | OK |
| PASS | DAX | card_field:data_as_of | OK |
| PASS | DAX | card_field:fetched_at | OK |
| PASS | DAX | card_field:data_note | OK |
| PASS | DAX | positive_price | OK |
...
| PASS | CSI_ALL_SHARE | freshness | 25s |
...
| PASS | EU10Y | change_pct_math | OK |
| PASS | EU10Y | source_trust | 官方 |
| PASS | EU10Y | freshness | 18s |
...
| PASS | FTSE100 | freshness | 4s |
| PASS | FTSE100 | valuation_scope | OK |
| PASS | CSI300 | price_history | 22 rows |
...
| PASS | CSI300 | total_return_history | 21 rows |
| PASS | CSI300 | total_return_not_snapshot_merged | OK |
| PASS | CSI500 | price_history | 22 rows |
...
| PASS | CSI500 | total_return_history | 21 rows |
| PASS | CSI500 | total_return_not_snapshot_merged | OK |
| PASS | CSI500_INDEX | price_history | 22 rows |
...
| PASS | CSI500_INDEX | total_return_history | 21 rows |
...
| PASS | CSI_DIVIDEND | total_return_history | 21 rows |
...
| PASS | CSI_DIVIDEND_100 | total_return_history | 21 rows |
...
| PASS | CSI300_DIVIDEND_LOW_VOL | total_return_history | 21 rows |
...
| PASS | CSI_DIVIDEND_QUALITY | total_return_history | 21 rows |
...
| PASS | CSI_ALL_DIVIDEND_QUALITY | total_return_history | 21 rows |
...
| PASS | CSI_CASH_FLOW | total_return_history | 21 rows |
...
| PASS | CNI_FREE_CASH_FLOW | total_return_history | 21 rows |
| PASS | CNI_FREE_CASH_FLOW | total_return_not_snapshot_merged | OK |
| PASS | CSI_BAIJIU | price_history | 22 rows |
...
| PASS | CSI_BAIJIU | total_return_history | 21 rows |
| PASS | CSI_BAIJIU | total_return_not_snapshot_merged | OK |
| PASS | CHINEXT | price_history | 22 rows |
...
| PASS | STAR50 | price_history | 22 rows |
...
| PASS | STAR50 | total_return_history | 21 rows |
| PASS | STAR50 | total_return_not_snapshot_merged | OK |
| PASS | STAR100 | price_history | 22 rows |
...
| PASS | STAR100 | total_return_history | 21 rows |
| PASS | STAR100 | total_return_not_snapshot_merged | OK |
| PASS | CN10Y | price_history | 21 rows |
...
| PASS | US10Y | price_history | 21 rows |
...
| PASS | HSTECH | price_history | 21 rows |
...
| PASS | DAX | price_history | 22 rows |
...
| PASS | DAX | total_return_history | 22 rows |
| PASS | DAX | total_return_not_snapshot_merged | OK |
| PASS | NDX | price_history | 20 rows |
...
| PASS | SPX | price_history | 20 rows |
...
| PASS | XOP | price_history | 20 rows |
...
| PASS | GOLD | price_history | 22 rows |
...
| PASS | OIL_WTI | price_history | 22 rows |
...
| PASS | CSI_ALL_SHARE | total_return_history | 21 rows |
...
| PASS | CSI1000 | total_return_history | 21 rows |
...
| PASS | CSI2000 | total_return_history | 21 rows |
| PASS | CSI2000 | total_return_not_snapshot_merged | OK |
| PASS | EU10Y | price_history | 21 rows |
...
| PASS | VIX | price_history | 22 rows |
...
| PASS | BTCUSD | price_history | 30 rows |
...
| PASS | ETHUSD | price_history | 30 rows |
...
| PASS | CAC40 | price_history | 21 rows |
...
| PASS | FTSE100 | price_history | 22 rows |
...
| PASS | CSI_DIVIDEND | dividend_return_history | 2427 rows, latest=5.22% |
| PASS | CSI_DIVIDEND | official_dividend_yield_source | csindex_indicator/股息率1 |
| PASS | CSI_DIVIDEND | official_dividend_yield_history | 20 rows, latest=5.32% |
| PASS | CSI_DIVIDEND_100 | csi_dividend_no_proxy | OK |
| PASS | CSI_DIVIDEND_100 | dividend_return_source | computed_dividend_yield |
| PASS | CSI_DIVIDEND_100 | dividend_return_history | 2427 rows, latest=4.76% |
| PASS | CSI_DIVIDEND_100 | official_dividend_yield_source | csindex_indicator/股息率1 |
| PASS | CSI_DIVIDEND_100 | official_dividend_yield_history | 20 rows, latest=5.19% |
...
| PASS | CSI300_DIVIDEND_LOW_VOL | dividend_return_history | 2426 rows, latest=4.81% |
| PASS | CSI300_DIVIDEND_LOW_VOL | official_dividend_yield_source | csindex_indicator/股息率1 |
| PASS | CSI300_DIVIDEND_LOW_VOL | official_dividend_yield_history | 20 rows, latest=4.91% |
...
| PASS | CSI_DIVIDEND_QUALITY | dividend_return_history | 2426 rows, latest=2.89% |
| PASS | CSI_DIVIDEND_QUALITY | official_dividend_yield_source | csindex_indicator/股息率1 |
| PASS | CSI_DIVIDEND_QUALITY | official_dividend_yield_history | 20 rows, latest=2.94% |
